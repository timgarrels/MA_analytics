...
export DATASET_DIRECTORY="./test_artifacts/datasets"
export EXPERIMENT_OUT="./test_artifacts/old_format"
export GTRIESCANNER_EXECUTABLE="IRRELEVANT"

python3 assert_result_equality.py \
--edgelist_name kaggle_star_wars.edgelist \
--graphlet_size 3 \
